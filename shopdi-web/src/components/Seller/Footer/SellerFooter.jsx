...
const Footer = () => {
    return (
        <div className={'font-sans text-[12px]'}>
            <div className='flex justify-around bg-[#3F81E0] text-white font-sans font-thin text-center'
            >
                <div>
                    <div/>
                    <div className={'text-left font-bold py-2'}>About</div>
                    <div className={'text-left'}>Shopdi aims to promote innovation in the digital<br/>
                    ...
                    <div className='flex mt-2 justify-around w-1/2 pb-2 '>
                ...
                <div>
                    <div className={'text-left font-bold py-2'}>Page</div>
                    <div className={'flex flex-col text-left'}>
                        <div className={'pb-0.5'}><a>About us</a></div>
                        <div className={'pb-0.5'}><a>Return Policy</a></div>
                        <div className={'pb-0.5'}><a>Contact Us</a></div>
                        <div className={'pb-0.5'}><a>Contact Refund & Cancellation Policies</a></div>
                    </div>

                </div>
                <div>
                    <div className='text-left font-bold my-2'>Shopdi</div>
                    <div className={'text-left'}>
                        <div className={'pb-0.5'}>About Shopdi</div>
                        <div className={'pb-0.5'}>Sell on Shopdi</div>
                        <div className={'pb-0.5'}>Shopdi Components</div>
                        <div className={'pb-0.5'}>Shopdi Debugger</div>
                        <div className={'pb-0.5'}>TSP For Shopdi</div>
                    </div>
                </div>
            ...
            <div
                ...
                <div>Term & condition || Privacy
                    Policy
                </div>
                <div>® 2024 TNHH WebWizards company.
                    All rights reserved
                </div>
            </div>
        </div>
