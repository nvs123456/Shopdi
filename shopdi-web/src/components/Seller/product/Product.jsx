...
export default function Product({ product }) {
    ...
    return (
        <div className={`grid grid-cols-8 h-24 items-center  border-b-2 border-gray-200 mb-4 pb-4 pl-4`}>
            ...
            <span className="min-w-24 text-left ">{product.soldQuantity}</span>
            <span className="min-w-24 text-left">{new Date(product.publishedOn).toLocaleString('vi', { day: 'numeric', month: 'numeric', year: 'numeric' })}</span>
