...
export default function Cart({ sellerGroups, selectedProducts, onSelect, setTotal, total, onDelete }) {
    ...
    return (
        <div className=" w-full font-sans min-h-screen bg-white border-[#E4E7E9] border-[1px]">
            <div className="grid grid-cols-8 w-full font-sans px-6 pt-6 text-[18px] font-bold text-yaleBlue border-[#E4E7E9] border-b-2">
            ...
            {sellerGroups && sellerGroups.map((seller) =>
                <div key={seller.sellerId} className="col-span-8">
                    <div className={"bg-[#F2F4F5] px-14 py-4 text-[16px] font-bold font-sans"}>SHOP - {seller.sellerName}</div>
