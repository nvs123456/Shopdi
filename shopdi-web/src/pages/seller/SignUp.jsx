...
const SellerSignUp = () => {
    ...
    return (
        < div >
            ...
            <div className={`${wait ? "brightness-50" : ""} bg-white`}>
                <div className={`flex min-h-full flex-1 flex-col justify-center px-0 py-5 lg:px-8 border-8 mx-auto max-w-[705px] my-20 `}>
